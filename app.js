...
function renderModalCard(c, border) {
  ...
  $("#modalContent").innerHTML = `<div class="border-toggle-row">${borderButtons}</div><div id="modalCard" class="modal-card ${cardBorderClass(border)}${c.characterName === "Marine" ? " marine-background" : ""}${c.characterName === "Blue Cat" ? " blue-cat-background" : ""}${c.characterName === "Demon Slayer" ? " bg-42" : ""}${c.characterName === "Cursed Vessel" ? " bg-43" : ""}${c.characterName === "Shoes" ? " bg-44" : ""}${c.characterName === "Steel Proxy" ? " bg-45" : ""}${c.characterName === "Copy Ninja" ? " bg-46" : ""}${c.characterName === "Crazy Wild Boar" ? " bg-47" : ""}${c.characterName === "Grumpy Princess" ? " bg-48" : ""}${c.characterName === "Forest Dryad" ? " bg-49" : ""}${c.characterName === "Remote Warlord" ? " bg-50" : ""}${c.characterName === "Water princess" ? " bg-51" : ""}${c.characterName === "Awakened Prodigy" ? " bg-52" : ""}${c.characterName === "Golden Lion Spear" ? " bg-53" : ""}${c.characterName === "Ranger Officer" ? " bg-54" : ""}${c.characterName === "World Champion" ? " bg-55" : ""}${c.characterName === "Blood girl" ? " bg-56" : ""}${c.characterName === "Elf Leader" ? " bg-57" : ""}${c.characterName === "God of thunder" ? " bg-58" : ""}${c.characterName === "Masked Strategist" ? " bg-59" : ""}${c.characterName === "Star Brawler" ? " bg-60" : ""}${c.characterName === "Chad of Conquerors" ? " bg-16" : ""}${c.characterName === "SPDR-06" ? " bg-17" : ""}${c.characterName === "Thornveil" ? " bg-18" : ""}${c.characterName === "The fake" ? " bg-19" : ""}${c.characterName === "Lucky Clown" ? " bg-20" : ""}${c.characterName === "Bloomera" ? " bg-21" : ""}${c.characterName === "Coward Goblin" ? " bg-22" : ""}${c.characterName === "Log" ? " bg-23" : ""}${c.characterName === "SWRM-87" ? " bg-24" : ""}${c.characterName === "Ninja Traitor" ? " bg-25" : ""}${c.characterName === "Legs Fighter" ? " bg-26" : ""}${c.characterName === "Prince" ? " bg-27" : ""}${c.characterName === "M.KA-21" ? " bg-28" : ""}${c.characterName === "Fatherboard" ? " bg-29" : ""}${c.characterName === "Ice Admiral" ? " bg-30" : ""}${c.characterName === "Electric Dragon" ? " bg-31" : ""}${c.characterName === "Spearman" ? " bg-32" : ""}${c.characterName === "Sword" ? " bg-33" : ""}${c.characterName === "Princess of Rejection" ? " bg-34" : ""}${c.characterName === "Cat Thief" ? " bg-35" : ""}${c.characterName === "Lost Sworsman" ? " bg-36" : ""}${c.characterName === "Water Ninja" ? " bg-37" : ""}${c.characterName === "Strongest Warrior" ? " bg-38" : ""}${c.characterName === "Armor" ? " bg-39" : ""}${c.characterName === "Green Cyborg" ? " bg-40" : ""}${c.characterName === "Malleable Man" ? " bg-41" : ""}${c.characterName === "Ball of feathers" ? " bg-2" : ""}${c.characterName === "Slime" ? " bg-3" : ""}${c.characterName === "Demon" ? " bg-4" : ""}${c.characterName === "Hole" ? " bg-5" : ""}${c.characterName === "Pusu Pusu" ? " bg-6" : ""}${c.characterName === "Cyber K.O.K.O" ? " bg-7" : ""}${c.characterName === "Koko" ? " bg-8" : ""}${c.characterName === "The cyclist" ? " bg-9" : ""}${c.characterName === "Knucklehead ninja" ? " bg-10" : ""}${c.characterName === "Eldergrove" ? " bg-11" : ""}${c.characterName === "Thunder Boy" ? " bg-12" : ""}${c.characterName === "FPLN-67" ? " bg-13" : ""}${c.characterName === "Young Hunter" ? " bg-14" : ""}${c.characterName === "Skyroot" ? " bg-15" : ""}">
